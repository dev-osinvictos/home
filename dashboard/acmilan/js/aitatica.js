...
// Milan defende à DIREITA e ataca à ESQUERDA
...
function getCurrentPossession() {
  ...
  notify("🤖 Allegri, está avaliando o adversário e ajustando o Milan...", 3000);
  ...
  try {
    ...
    const res = await fetch("https://acmilan-5qt5.onrender.com/ai/analyze", {
      method: "POST",
    ...
    // === Atualiza HUD Tático ===
    hudForm.textContent = `Adversário: ${data.opponentFormation || "?"} | Milan ${data.detectedFormation || "?"}`;
